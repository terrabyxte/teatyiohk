 ...
 */
public class PinpointV2Localizer implements Localizer {
    private final GoBildaPinpointDriverV2 odo;
     ...
     */
    public PinpointV2Localizer(HardwareMap map, PinpointV2Constants constants){ this(map, constants, new Pose());}
     ...
     */
    @SuppressLint("NewApi")
    public PinpointV2Localizer(HardwareMap map, PinpointV2Constants constants, Pose setStartPose){

        odo = map.get(GoBildaPinpointDriverV2.class, constants.hardwareMapName);
